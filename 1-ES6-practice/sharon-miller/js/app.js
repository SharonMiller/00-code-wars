...
function displayPics(){
  ...
  // Because it was in the while loop and could not be seen outside of it
  console.log(viewed)
...
function showList() {
  for(let i = 0; i < allProducts.length; i++) {
    ...
    liEl.textContent = `${PallProducts[i].name} has ${allProducts[i].votes} votes in ${allProducts[i].views} views`;
